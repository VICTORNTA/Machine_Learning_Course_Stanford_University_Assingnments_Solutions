...
sigma_list = [0.01;0.1;0.3;1;3;10;30;100];
error_list = zeros(64,3);
% ====================== YOUR CODE HERE ======================
...
##  predictions =  svmPredict(model,Xval);
##  error_list(k,:) = [mean(double(predictions ~= yval)),C_list(i),sigma_list(j)];
##  endfor
##endfor
##errno_list
##[minimum_error,indx] = min(error_list(:,1));
##minimum_error
##C
##sigma
##C = error_list(indx,2);
##sigma = error_list(indx,3);
C_list     = [0.01 0.03 0.1 0.3 1 3 10 30]';
